...
# Create Security Group for App_Tier & Connect to ALB
...
# Create Launch Templates for App Tier Apache Instances
...
# Create Autoscaling Group for App Tier Instances
...
# Create Autoscaling Attachment for App Tier Instances
